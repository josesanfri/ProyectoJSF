...
class CreateRestaurantView(CreateAPIView):
    ...
    def get_serializer(self, *args, **kwargs):
        ...
        Returns:
            ModelSerializer: serializer for Menu
        """ 
        return MenusSerializer(data=self.request.data)

## MENU RUD VIEWS ##
class RetrieveUpdateDestroyMenuView(RetrieveUpdateDestroyAPIView):
    queryset = Menu.objects.all()
    multiple_lookup_fields = ('id', 'slug_menu')
    ...
    def get_permissions(self):
        ...
        return super(RetrieveUpdateDestroyMenuView, self).get_permissions()
    ...
    def get_serializer(self, *args, **kwargs):
        ...
        if self.request.method == 'PUT':          
            return MenusSerializer(instance=instance, data=data_dict)
            
        return MenusSerializer(instance=instance)
