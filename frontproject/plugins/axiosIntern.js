...
export default function ({ $axios, redirect, store, req }, inject) {
    ...
    const InternAPI = $axios.create({
        baseURL: `${process.env.NUXT_ENV_SERVER_HOST ? 'http://backend:8000/' : 'http://localhost:8000/'}api/`,
        headers: {
    ...
    InternAPI.interceptors.request.use(function(config) {
